...
# каталога данных, поэтому разрешения ему не требуются. Ключ намеренно
# закомментирован: пустое значение buildozer превращает в одну пустую строку
# и записывает в манифест бессмысленное разрешение 'android.permission.'.
# android.permissions =
